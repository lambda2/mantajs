...
{
	if (window.CleverCode == undefined)
	{
		window.CleverCode = {};
	}

	if (window.CleverCode.definitions == undefined)
	{
		window.CleverCode.definitions = {};
	}
}
...
CleverCode.annotations = [
	{name: "@author", icon: "icon-quill"},
	{name: "@constructor"},
	{name: "@deprecated"},
	{name: "@exception"},
	{name: "@param", icon: "icon-arrow-right3"},
	{name: "@private"},
	{name: "@return", icon: "icon-arrow-left3"},
	{name: "@returns", icon: "icon-arrow-left3"},
	{name: "@see", icon: "icon-eye"},
	{name: "@this"},
	{name: "@throws", icon: "icon-alert2"},
	{name: "@version"}
];

CleverCode.definitions.base =
{
	commentBlock : /\/\*([^*]|[\r\n]|(\*+([^*/]|[\r\n])))*\*+\//mg,
	commentLine : ["\/\/.*"],
	commentBlockDelimiters : /(\/\*\*?)|([\s]?\*\/?[\s]?)/mg,
	blockDelimiter : {
		start: "{",
		end: "}"
	}
...
CleverCode.definitions.php = _.extend(CleverCode.definitions.base, phpDefinition);
